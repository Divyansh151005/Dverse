...
### make sure that port in truffle-config.js is same as ganche port 
...
`$ ganache cli --port 7545 , running on port 7545 hence the testent in metamsk was also ganache with this rpc url `